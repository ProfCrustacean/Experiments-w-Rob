...
- Last updated: 2026-02-22T01:31:04.088Z
- Window: trailing 7 days
- Store scope: continente
- Pipeline runs in scope: 27 (previous window: 0)
...
| --- | --- | --- | --- | --- |
| `fallback_category_rate` | <= 0.0600 | 0.0325 | n/a | From pipeline run stats |
| `needs_review_rate` | <= 0.3500 | 0.4662 | n/a | From pipeline run stats |
| `auto_accepted_rate` | >= 0.8000 (canary) | 0.5706 | n/a | Canary-labeled runs only |
...
1. Needs-review rate is above target (0.4662 > 0.3500).
2. Canary auto-accepted rate is below threshold (0.5706 < 0.8000).
