    ...
    JSON.stringify(
      {
        ...
        agentDocCount: result.agentDocCount,
        oversizeDocCount: result.oversizeDocCount,
        missingSectionCount: result.missingSectionCount,
        moduleCoverageRate: result.moduleCoverageRate,
        ownerCoverageRate: result.ownerCoverageRate,
      },
      null,
      2,
    ),
